...
const SingleProductStickySection = () => {
    ...
    <div className='sticky-main-container'>
        ...
        <div className='thumbnail-slider-container'>
          ...
          <div className='thumbnail-slider' ref={thumbnailSliderRef}>
            {sliderImages.map((thumbnailItem, thumbnailIndex) => (
              ...
              >
                <img src={thumbnailItem.img} alt={thumbnailItem.name} />
              </div>
            ))}
          </div>
      ...
      <div className='right-section'>
        <div className='single-product-detail-container'>
            ...
            <h3 className='single-product-price'>$ 859.00</h3>
            <p className='single-product-installment-price-price'>$9/month for 6 months - Total $859.99</p>
