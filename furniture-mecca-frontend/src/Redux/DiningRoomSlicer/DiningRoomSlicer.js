...
const productsSlicer = createSlice({
    ...
    initialState: {
        data: [
            ...
            {heart: heartImg, mainImage: muellerSofa, hoverImage: sherryImage , productTitle: `Avenger Black 89'' Power Reclining Sofa & 78'' Reclining Console Loveseat with USB`, ratingStars: [
                    {icon: filledStar, title: 'filled'},
                    {icon: filledStar, title: 'filled'},
                    {icon: filledStar, title: 'filled'},
                    {icon: filledStar, title: 'filled'},
