...
const productCardSlicer = createSlice({
    ...
    initialState: {
        data: [
            ...
            // {id: 7, productTitle: "Stevie Charcoal 87'' Sofa & Chair", defaultPrice: '$ 188.00', priceTag: '$ 1,599.00', heartIcon: heartIcon, mainImage: productImageOne, ratingStars: Array(5).fill({starIcon: starIcon}), reviews: '(200)', category: 'bedroom'  },
            ...
            // {id: 13, productTitle: "Stevie Charcoal 87'' Sofa & Chair", defaultPrice: '$ 188.00', priceTag: '$ 1,599.00', heartIcon: heartIcon, mainImage: productImageOne, ratingStars: Array(5).fill({starIcon: starIcon}), reviews: '(200)', category: 'dining-room'  },
